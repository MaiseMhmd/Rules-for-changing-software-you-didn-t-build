...
Rules for working with an AI coding agent on software that is **already built and in production** — joining mid-project, with real users and real data, where the agent writes the actual code.

---

# Section A — Working in an Inherited, Live Codebase
...
- Working in a live, inherited codebase is not a creativity problem — it's a **blast-radius** problem
